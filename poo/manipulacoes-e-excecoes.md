...
Muitos desenvolvedores juniores usam exceções para "controle de fluxo" (ex: lançar exceção para validar se um campo está vazio). **Não faça isso. As exceções preferencialmente NUNCA devem fazer tratativas de negócio**
